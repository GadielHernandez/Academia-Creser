                                    ...
                                    <v-list-item>
                                        ...
                                        <v-list-item-content>
                                            <p class="ma-auto text-caption">
                                                <v-chip color="primary" dark small label class="mr-1">{{ Number.isInteger(t.available_after / (( 1000 * 60 * 60 * 24 * 7 ))) ? t.available_after / (( 1000 * 60 * 60 * 24 * 7 )) : (t.available_after / (( 1000 * 60 * 60 * 24 * 7 ))).toFixed(1) }} semanas</v-chip>
                                                <v-chip color="primary" dark small label >{{ t.questions.length }} preguntas</v-chip>
                                            </p>
                                        </v-list-item-content>
                                        <v-list-item-action>
